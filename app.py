...
def main():
    ...
    if selected == "Home":
        ...
        html_temp_home1 = """
                            <div>
                                <p class="bodyP1">Welcome to RED. This is an emotion recognition web application! Our application combines OpenCV and Convolutional Neural Networks to accurately identify emotions in real-time. </p>
                                <h2>Try Now</h2>
                                <p>Click on start to use webcam and detect your face emotion</p>
                            </div>
                            """
        st.markdown(html_temp_home1, unsafe_allow_html=True)
        webrtc_streamer(key="example", video_processor_factory=EmotionDetector, async_processing=True,audio_processor_factory=None)
        html_home2  = """
            <div class="footer">
